...
# author: "Hanieh Heidarpour Kiaei"
# date: "15/011/2022"
# file description: "Regression and model validation, learning2014 dataset"
...
test_learning2014 <- read_csv('learning2014.csv')
str(test_learning2014)
head(test_learning2014)
